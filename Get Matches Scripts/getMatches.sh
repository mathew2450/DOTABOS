...
curl --get 'http://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/v001/?key=A15BA1CAED87271BB1B6567D7D493227&skill=2&game_mode=1&min_players=10&hero_id=1&matches_requested=50&start_at_match_id=3147986583' > test/matchList.txt
